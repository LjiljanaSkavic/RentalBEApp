...
INSERT INTO rentaldb.employee (id, role, user_id)
VALUES (1, 'Admin', 1),
       (2, 'Manager', 2),
       (3, 'Operator', 3);

-- Insert into client
INSERT INTO rentaldb.client (id, card_number, is_blocked, user_id)
VALUES (1, '1234567890', false, 4),
...
INSERT INTO rentaldb.rental (start, end, start_location, end_location, duration, identification_card, driver_licence,
                             client_id, vehicle_id)
VALUES ('2024-03-25 10:00:00', '2024-03-25 12:00:00', POINT(44.7732, 17.1910), POINT(43.8486, 18.3564), '02:00:00',
        '1234567890', 'D1234567', 1, 1), -- Tesla Model 3 rental (Banja Luka to Sarajevo)
       ('2024-03-24 08:00:00', '2024-03-24 09:30:00', POINT(44.7732, 17.1910), POINT(44.7716, 18.1473), '01:30:00',
        '0987654321', 'D7654321', 2, 2), -- Tesla Model X rental (Banja Luka to Doboj)
       ('2024-03-23 14:00:00', '2024-03-23 16:30:00', POINT(44.7732, 17.1910), POINT(44.8734, 18.8045), '02:30:00',
        '1122334455', 'D1122334', 1, 3), -- BMW i3 rental (Banja Luka to Brcko)
       ('2024-03-22 11:00:00', '2024-03-22 13:00:00', POINT(44.7732, 17.1910), POINT(43.3438, 17.8070), '02:00:00',
